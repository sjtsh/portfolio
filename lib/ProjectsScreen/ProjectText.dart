...
class ProjectText extends StatelessWidget {
  ...
  final List description = const [
    ...
    "2021 | 4 screens, 1977 lines of code | Made a static minimalist Flutter web application from scratch as a repository for my projects featuring\n\n• Minimalist design with animations and reactive to hover\n• Used native javascript code to hyperlink to new tab through web libraries\n•Created a scalable svg logo and pre cached assets on splash screen\n\nUsed Dart as backend, Flutter as framework, Git for version control, Figma for design, Illustrator for logo, Firebase for hosting and After Effects for animation"
  ];
  final List projectLogos = const [
    "icons/appetit.png",
    "icons/wardrobe.png",
    "icons/portfolio.png"
  ];
        ...
        child: Column(
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                fontSize: MediaQuery.of(context).size.width > 800 ? 26 : 16,
                color: Colors.white,
              ),
            ),
